    ...
    <div class=" sidebar d-flex flex-column flex-shrink-0 pb-1 px-2 text-white bg-orange" style="width: 280px;">
      ...
      <ul class="nav nav-pills flex-column mb-auto">
        ...
        <ul>
          ...
          <li><a href="./dashboard_threads.php" class="nav-link my-3 active-success text-white">Threads</a></li>
    ...
    <div class="container overview-container">
        ...
        <?php 
          if(isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == true) {
            ...
            echo'<h4 class=" text-center">Your posted total questions : '. $num_posted_question .'</h4>';
            while($row = mysqli_fetch_assoc($result)) {
                $thread_title = $row['thread_title'];
                $thread_des = $row['thread_des'];
                $thread_id = $row['thread_cat_id'];
                echo'<h6 class="mt-0"><a class="text-success mx-3" href="threadlist.php?catid='.$thread_id.'">'. $thread_title .'</a></h6>
                <p class = "text-dark mx-3">'. $thread_des .'</p>
                <a class="btn btn-outline-danger btn-lg mt-0 mb-3 mx-3" href="threadlist.php?catid='.$thread_id.'" role="button">See More</a>';
              }
            }
