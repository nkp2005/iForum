  ...
  <div class="mainContainer row">
        ...
        <a href="./account_profile.php" class="nav-link active-success text-white"> Account Setting </a>
          ...
          <li>
            ...
            <ul>
              ...
              <li><a href="./account_profile_delete.php" class="nav-link active-success my-3 text-white">Delete Profile</a></li>
            </ul>
          </li>
    ...
    <div class="container overview-container">
        <div class="jumbotron jumbotron-fluid py-4">
            <h4 class=" text-center">Your posted total comments : (number)</h4>

            <p class="text-success py-0 px-0 my-0 mx-0"><a class="text-success" href="thread.php?threadid=91">admin at 2024-08-31 11:44:26</a></p>
            <p class="mt-0">@nareshkumar nice question bro</p>
